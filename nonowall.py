...
def remove_walls(pcd_path, output_dir,
                voxel_size=0.03,
    ...
    # --- 디버깅용: 법선 시각화 ---
    # o3d.visualization.draw_geometries([pcd_for_normals], point_show_normal=True, window_name="Normals for Debugging")
